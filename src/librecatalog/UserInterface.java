...
public class UserInterface
{
    ...
    //<editor-fold defaultstate="collapsed" desc="Patrons.Record methods">
    ...
    public static void modPatron( int userLevel )
    {
        if ( userLevel == 1 ) {
            ...
            if ( tomodify != null ) {
                ...
                Patrons.Record replacement = new Patrons.Record( tomodify.getBarcode(),
                                                                 tomodify.getFirstName(),
                                                                 tomodify.getLastName(),
                                                                 tomodify.getAddress(),
                                                                 tomodify.getEmail(),
                                                                 tomodify.getPhoneNumber(),
                                                                 tomodify.getBirthDay(),
                                                                 tomodify.getBirthMonth(),
                                                                 tomodify.getBirthYear() );
                int choice = 0;
                do {
                    ...
                    switch ( choice ) {
                        ...
                        case 5:
                            ...
                            break;
                        case 6:
                            int birthYear = askUserForInt( title,
                                                    "Enter the Year the patron was Born." );
                            int birthMonth = askUserForInt( title,
                                                        "Enter the Month the patron was Born." );
                            while ( birthMonth > 12 ) {
                                birthMonth = askUserForInt( title,
                                                            "Enter the Month the patron was Born." );
                            }
                            int birthDay = askUserForInt( title, "Enter the Day the patron was Born." );
                            while ( birthDay > 31 ) {
                                birthDay = askUserForInt( title,
                                                        "Enter the Day the patron was Born." );
                            }
                            replacement.setBirthDay( birthDay );
                            replacement.setBirthMonth( birthMonth );
                            replacement.setBirthYear( birthYear );
                            break;
                        case 7:
    ...
    //<editor-fold defaultstate="collapsed" desc="Items.Record methods">
    ...
    static void addItem( int userLevel )
    {
        ...
        if ( userLevel == 1 ) {
            ...
            barcode = "2" + Configure.getSetting( "library" ) + Items.nextAvailableNumber();
            ...
            String message = "Confirm adding the following Item:\n"
                    ...
                    + "Date written: " + Date;
            if ( confirm( title, message ) )
                Items.addItem( new Items.Record( barcode,
                                                 Title,
                                                 Author,
                                                 Genre,
                                                 shelfLocation,
