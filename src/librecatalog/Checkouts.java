   ...
   static class Record implements Serializable
    ...
    public static class checkoutsTab extends JTabbedPane
    {
        ...
        checkoutsTab(int userLevel)
        {
            ...
            if (userLevel == 3) {
                add(new JScrollPane(new Checkouts.checkoutsTab.listCheckoutsPanel()), "List Checkouts for Patron");
            } else {
                add(new JScrollPane(new Checkouts.checkoutsTab.listAllCheckoutsPanel()), "List All Checkouts");
                add(new JScrollPane(new Checkouts.checkoutsTab.listCheckoutsPanel()), "List Checkouts for Patron");
            }
        }//end constructor
        
        static void resetPanels() {
            Checkouts.checkoutsTab.listCheckoutsPanel.resetPanel();
            Checkouts.checkoutsTab.listAllCheckoutsPanel.resetPanel();
        }
